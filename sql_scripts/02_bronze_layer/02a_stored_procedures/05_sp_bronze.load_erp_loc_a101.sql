-- =============================================
-- Bronze Layer: Automated Load Procedure - ERP Customer Location
-- =============================================
-- Purpose: Load raw customer location data from CSV to Bronze layer
-- Strategy: Full reload - TRUNCATE + INSERT preserving source structure
-- Source: CSV file (LOC_A101.csv)
...
DROP PROCEDURE IF EXISTS bronze.load_erp_loc_a101;
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT @rows_before_truncate = COUNT(*) FROM bronze.erp_loc_a101;
        ...
        FROM 'C:\Users\User\Desktop\DW Project\sql-data-warehouse-project\sql-data-warehouse-project\datasets\source_erp\LOC_A101.csv'
        WITH (
            FIELDTERMINATOR = ',',
            FIRSTROW = 2, 
            TABLOCK
